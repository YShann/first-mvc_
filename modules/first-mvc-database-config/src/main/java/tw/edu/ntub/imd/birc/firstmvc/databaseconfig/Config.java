package tw.edu.ntub.imd.birc.firstmvc.databaseconfig;
...
@EnableJpaRepositories(basePackages = "tw.edu.ntub.imd.birc.firstmvc.databaseconfig.dao")
@EnableTransactionManagement
@EntityScan(basePackages = "tw.edu.ntub.imd.birc.firstmvc.databaseconfig.entity")
public class Config {
    public static final String DATABASE_NAME = "firstmvc";
