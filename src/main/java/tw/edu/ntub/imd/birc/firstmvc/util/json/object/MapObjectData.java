package tw.edu.ntub.imd.birc.firstmvc.util.json.object;

import com.fasterxml.jackson.databind.JsonNode;
import tw.edu.ntub.imd.birc.firstmvc.util.function.AddObjectDataMapConsumer;
import tw.edu.ntub.imd.birc.firstmvc.util.function.TripleConsumer;
import tw.edu.ntub.imd.birc.firstmvc.util.json.ResponseData;
...
public class MapObjectData implements ResponseData {
    private final tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData objectData;

    public MapObjectData() {
        objectData = new tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData();
    }

    protected MapObjectData(tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData objectData) {
    ...
    public <K, V> MapObjectData addArray(String key, Map<K, V> resource, TripleConsumer<tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData, K, V> addObjectDataConsumer) {
    ...
    public <K, V> BiConsumer<K, V> addArrayAndAddObjectToNewArray(String key, TripleConsumer<tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData, K, V> addObjectDataConsumer) {
