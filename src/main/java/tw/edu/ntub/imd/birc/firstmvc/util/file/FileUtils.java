...
import tw.edu.ntub.imd.birc.firstmvc.exception.file.InvalidCharsetException;
import tw.edu.ntub.imd.birc.firstmvc.exception.file.InvalidOptionException;
import tw.edu.ntub.imd.birc.firstmvc.exception.file.UnauthorizedException;
...
public class FileUtils {
    ...
    public Path getFilePath(@Nonnull String filePath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.firstmvc.exception.file.InvalidPathException(e, filePath);
        }
    }
    ...
    public Path getDirectoryPath(@Nonnull String firstDirectoryPath, String... subDirectoryPath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.firstmvc.exception.file.InvalidPathException(e, firstDirectoryPath, subDirectoryPath);
        }
    }
