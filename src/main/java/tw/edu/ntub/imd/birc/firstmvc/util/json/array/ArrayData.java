...
public class ArrayData implements ResponseData {
    ...
    public tw.edu.ntub.imd.birc.firstmvc.util.json.array.CollectionArrayData addCollectionToThis() {
        return new tw.edu.ntub.imd.birc.firstmvc.util.json.array.CollectionArrayData(this);
    }

    public tw.edu.ntub.imd.birc.firstmvc.util.json.array.CollectionArrayData addCollectionToNewArray() {
        return new tw.edu.ntub.imd.birc.firstmvc.util.json.array.CollectionArrayData(addArray());
    }
