...
import tw.edu.ntub.imd.birc.firstmvc.dto.CodeEntry;
import tw.edu.ntub.imd.birc.firstmvc.util.function.AddObjectDataConsumer;
...
public class CollectionObjectData implements ResponseData {
    ...
    public CollectionObjectData() {
        this(new tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData());
    }

    protected CollectionObjectData(tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData objectData) {
    ...
    public <T> CollectionObjectData add(String key, Collection<T> resource, BiConsumer<tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData, T> addObjectDataConsumer) {
    ...
    public <T> Consumer<T> addArrayAndAddObjectToNewArray(String key, BiConsumer<tw.edu.ntub.imd.birc.firstmvc.util.json.object.ObjectData, T> addObjectDataConsumer) {
