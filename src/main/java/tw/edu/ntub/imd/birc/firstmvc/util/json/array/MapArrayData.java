package tw.edu.ntub.imd.birc.firstmvc.util.json.array;
...
public class MapArrayData implements ResponseData {
    private final tw.edu.ntub.imd.birc.firstmvc.util.json.array.ArrayData arrayData;

    public MapArrayData() {
        arrayData = new tw.edu.ntub.imd.birc.firstmvc.util.json.array.ArrayData();
    }

    protected MapArrayData(tw.edu.ntub.imd.birc.firstmvc.util.json.array.ArrayData arrayData) {
    ...
    public <K, V> MapArrayData addArray(Map<K, V> map, TripleConsumer<ObjectData, K, V> addObjectDataConsumer) {
        tw.edu.ntub.imd.birc.firstmvc.util.json.array.ArrayData newArrayData = arrayData.addArray();
